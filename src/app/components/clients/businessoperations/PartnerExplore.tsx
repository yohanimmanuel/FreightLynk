...
const PartnerExplore: React.FC<PartnerExploreProps> = ({ view = 'full' }) => {
  const [searchTerm, setSearchTerm] = useState('');
  const [filterType, setFilterType] = useState('All Services');
  
  // Sample data for recommended partners
  ...
  const filteredPartners = recommendedPartners.filter(partner => 
